jQuery(document).ready(function($) {
    'use strict';
    var this_obj = it_company_lite_plugin_activate_plugin;
    ...
    $(document).on('click', '.it-company-lite-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message it-company-lite-plugin-install');
                button.addClass('button-primary it-company-lite-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.it-company-lite-recommended-plugins .it-company-lite-activation-note').css('display','block');
    ...
    $(document).on('click', '.it-company-lite-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .it-company-lite-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .it-company-lite-recommended-plugins').css('display','none');
    });
