...
class IT_Company_Lite_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'IT_Company_Lite_About_Widget',
			__('VW About us', 'it-company-lite'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'it-company-lite' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','it-company-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','it-company-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','it-company-lite'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','it-company-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','it-company-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','it-company-lite'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function it_company_lite_about_custom_load_widget() {
	register_widget( 'IT_Company_Lite_About_Widget' );
}
add_action( 'widgets_init', 'it_company_lite_about_custom_load_widget' );