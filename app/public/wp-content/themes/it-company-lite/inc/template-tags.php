...
add_theme_support( 'admin-bar', array( 'callback' => 'it_company_lite_my_admin_bar_css') );
function it_company_lite_my_admin_bar_css(){
?>
 ...
 * Posts pagination.
 */
if ( ! function_exists( 'it_company_lite_blog_posts_pagination' ) ) {
	function it_company_lite_blog_posts_pagination() {
		$pagination_type = get_theme_mod( 'it_company_lite_blog_pagination_type', 'blog-page-numbers' );
