 ...
 */
function metasoft_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function metasoft_sanitize_html( $html ) {
 ...
 */
function metasoft_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function metasoft_sanitize_range_value( $number, $setting ) {
 ...
 */
function metasoft_sanitize_select( $input, $setting ) {
 ...
 */
function metasoft_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function metasoft_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function metasoft_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}