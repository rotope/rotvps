/* global jQuery */
/* global wp */
function metasoft_media_upload(button_class) {
    'use strict';
 ...
 *** Generate unique id ***
 *********************************************/
function metasoft_customizer_repeater_uniqid(prefix, more_entropy) {
    'use strict';
 ...
 *** General Repeater ***
 *********************************************/
function metasoft_customizer_repeater_refresh_social_icons(th) {
    'use strict';
    ...
    th.find('.customizer-repeater-social-repeater-container').each(function () {
        ...
        if (!id) {
            id = 'customizer-repeater-social-repeater-' + metasoft_customizer_repeater_uniqid();
    ...
    metasoft_customizer_repeater_refresh_general_control_values();
}


function metasoft_customizer_repeater_refresh_general_control_values() {
    'use strict';
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            if (!id) {
                id = 'social-repeater-' + metasoft_customizer_repeater_uniqid();
            ...
            if (text !== '' || image_url !== ''  || image_url2 !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || slide_align !== '' || color !== '') {
                values.push({
                    ...
                    'color': color,
                    'color2': color2,
                    'text': metasoftescapeHtml(text),
                    'link': link,
                    'text2': metasoftescapeHtml(text2),
                    'link2': link2,
                    'image_url': (choice === 'customizer_repeater_none' ? '' : image_url),
                    'choice': choice,
					'image_url2': image_url2,
                    'title': metasoftescapeHtml(title),
                    'subtitle': metasoftescapeHtml(subtitle),
					'slide_align': metasoftescapeHtml(slide_align),
                    'social_repeater': metasoftescapeHtml(social_repeater),
                    'id': id,
                    'shortcode': metasoftescapeHtml(shortcode)
                });
            }
...
jQuery(document).ready(function () {
    'use strict';
    var metasoft_theme_controls = jQuery('#customize-theme-controls');
    metasoft_theme_controls.on('click', '.customizer-repeater-customize-control-title', function () {
    ...
    metasoft_theme_controls.on('change', '.icp',function(){
        metasoft_customizer_repeater_refresh_general_control_values();
        return false;
    });
	
	metasoft_theme_controls.on('change','.customizer-repeater-slide-align', function(){
		metasoft_customizer_repeater_refresh_general_control_values();
        return false;
		
	});
	
	metasoft_theme_controls.on('change','.customizer-repeater-image2-control', function(){
		metasoft_customizer_repeater_refresh_general_control_values();
        return false;
    ...
    metasoft_theme_controls.on('change', '.customizer-repeater-image-choice', function () {
    ...
    metasoft_media_upload('.customizer-repeater-custom-media-button');
     ...
     *
     */
    metasoft_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        var split_add_more_button=jQuery(this).text();
        var split_add_more_button_split=split_add_more_button.substr(4, 12);
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-' + metasoft_customizer_repeater_uniqid();
		
		if(split_add_more_button_split=="Add New Slid")
        {
        if(jQuery('#exist_metasoft_Slider').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_metasoft_Slider').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_metasoft_Slider').val())+1;
         jQuery('#exist_metasoft_Slider').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Info")
        {
        if(jQuery('#exist_metasoft_Info').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_metasoft_Info').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_metasoft_Info').val())+1;
         jQuery('#exist_metasoft_Info').val(new_service_add_val);  
        }
        }
		
		 if(split_add_more_button_split=="Add New Serv")
        {
        if(jQuery('#exist_metasoft_Service').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_metasoft_Service').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_metasoft_Service').val())+1;
         jQuery('#exist_metasoft_Service').val(new_service_add_val);  
        }
        }
         if(split_add_more_button_split=="Add New Expe")
        {
        if(jQuery('#exist_metasoft_Expertise').val()>=6)
        {
        jQuery(".customizer_expertise_upgrade_section").show();
        return false;   
        }
         if(jQuery('#exist_metasoft_Expertise').val()<6)
        {
         var new_service_add_val=parseInt(jQuery('#exist_metasoft_Expertise').val())+1;
         jQuery('#exist_metasoft_Expertise').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Soci")
        {
        if(jQuery('#exist_metasoft_Social').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_metasoft_Social').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_metasoft_Social').val())+1;
         jQuery('#exist_metasoft_Social').val(new_service_add_val);  
        }
        }
    ...
    metasoft_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_metasoft_Slider').val(parseInt(jQuery('#exist_metasoft_Slider').val())-1);  
                }
				
				if(split_delete_button_split=="Delete Info")
                {
                jQuery('#exist_metasoft_Info').val(parseInt(jQuery('#exist_metasoft_Info').val())-1);  
                }
				
				if(split_delete_button_split=="Delete Serv")
                {
                jQuery('#exist_metasoft_Service').val(parseInt(jQuery('#exist_metasoft_Service').val())-1);  
                }
				if(split_delete_button_split=="Delete Expe")
                {
                jQuery('#exist_metasoft_Expertise').val(parseInt(jQuery('#exist_metasoft_Expertise').val())-1); 
                }
				if(split_delete_button_split=="Delete Soci")
                {
                jQuery('#exist_metasoft_Social').val(parseInt(jQuery('#exist_metasoft_Social').val())-1); 
                }
    ...
    metasoft_theme_controls.on('keyup', '.customizer-repeater-title-control', function () {
        metasoft_customizer_repeater_refresh_general_control_values();
    });
    ...
    metasoft_theme_controls.on('keyup', '.customizer-repeater-subtitle-control', function () {
        metasoft_customizer_repeater_refresh_general_control_values();
    });

    metasoft_theme_controls.on('keyup', '.customizer-repeater-shortcode-control', function () {
        metasoft_customizer_repeater_refresh_general_control_values();
    });

    metasoft_theme_controls.on('keyup', '.customizer-repeater-text-control', function () {
        metasoft_customizer_repeater_refresh_general_control_values();
    });

    metasoft_theme_controls.on('keyup', '.customizer-repeater-link-control', function () {
        metasoft_customizer_repeater_refresh_general_control_values();
    });

    metasoft_theme_controls.on('keyup', '.customizer-repeater-text2-control', function () {
        metasoft_customizer_repeater_refresh_general_control_values();
    });

    metasoft_theme_controls.on('keyup', '.customizer-repeater-link2-control', function () {
        metasoft_customizer_repeater_refresh_general_control_values();
    });
    ...
    /*----------------- Socials Repeater ---------------------*/
    metasoft_theme_controls.on('click', '.social-repeater-add-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-social-repeater-' + metasoft_customizer_repeater_uniqid();
        if (typeof th !== 'undefined') {
    ...
    metasoft_theme_controls.on('click', '.social-repeater-remove-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var repeater = jQuery(this).parent().parent();
        th.remove();
        metasoft_customizer_repeater_refresh_social_icons(repeater);
        return false;
    });

    metasoft_theme_controls.on('keyup', '.customizer-repeater-social-repeater-link', function (event) {
        event.preventDefault();
        var repeater = jQuery(this).parent().parent();
        metasoft_customizer_repeater_refresh_social_icons(repeater);
        return false;
    ...
    metasoft_theme_controls.on('change', '.customizer-repeater-social-repeater-container .icp', function (event) {
        event.preventDefault();
...
function metasoftescapeHtml(string) {
    'use strict';
    //noinspection JSUnresolvedFunction
    string = String(string).replace(new RegExp('\r?\n', 'g'), '<br />');
    string = String(string).replace(/\\/g, '&#92;');
    return String(string).replace(/[&<>"'\/]/g, function (s) {
        return metasoftentityMap[s];
    });
