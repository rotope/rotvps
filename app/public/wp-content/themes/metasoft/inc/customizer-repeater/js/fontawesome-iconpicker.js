(function ($) {
    ...
    wp.metasoftcustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                metasoft_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.metasoftcustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.metasoftcustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.metasoftcustomizerRepeater.iconPickerToggle($(this));
        });
