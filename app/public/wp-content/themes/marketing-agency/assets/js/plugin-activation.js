jQuery(document).ready(function($) {
    'use strict';
    var this_obj = marketing_agency_plugin_activate_plugin;
    ...
    $(document).on('click', '.marketing-agency-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message marketing-agency-plugin-install');
                button.addClass('button-primary marketing-agency-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.marketing-agency-recommended-plugins .marketing-agency-activation-note').css('display','block');
    ...
    $(document).on('click', '.marketing-agency-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .marketing-agency-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .marketing-agency-recommended-plugins').css('display','none');
    });
