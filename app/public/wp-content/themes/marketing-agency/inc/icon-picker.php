...
class Marketing_Agency_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'marketing-agency' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $marketing_agency_font_awesome_icon_array = marketing_agency_font_awesome_icon_array();
                    foreach ($marketing_agency_font_awesome_icon_array as $marketing_agency_font_awesome_icon) {
                            $icon_class = $this->value() == $marketing_agency_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($marketing_agency_font_awesome_icon).'"></i>
                            <span class="marketing-agency-social-class">'.esc_attr($marketing_agency_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function marketing_agency_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'marketing-agency-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'marketing_agency_customizer_script' );

if(!function_exists('marketing_agency_font_awesome_icon_array')){
    function marketing_agency_font_awesome_icon_array(){
