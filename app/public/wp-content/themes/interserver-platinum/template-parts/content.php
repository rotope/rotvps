...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<?php 
	global $ip_default;
	$index_feat_img = get_theme_mod( 'index_feat_image', $ip_default['index_feat_image'] );
	if ( has_post_thumbnail() && ! $index_feat_img ) : ?>
		<div class="entry-thumb">
			<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail('interserver-platinum-large-thumb');?></a>
		</div>
	<?php endif; ?>
